...
var _user$project$Boys$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Boys$initModel = {count: 0, sisters: 0};
var _user$project$Boys$init = {ctor: '_Tuple2', _0: _user$project$Boys$initModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Boys$Model = F2(
	function (a, b) {
		return {count: a, sisters: b};
	});
var _user$project$Boys$AddSister = {ctor: 'AddSister'};
var _user$project$Boys$Increment = {ctor: 'Increment'};
var _user$project$Boys$view = function (model) {
	return A2(
			...
			_0: _elm_lang$html$Html$text(
				A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(model.sisters),
							' sisters ')))),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Boys$Increment),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Add Boy'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Boys$NewBoy = {ctor: 'NewBoy'};
var _user$project$Boys$update = F2(
	function (msg, model) {
		var _p0 = msg;
...
var _user$project$Girls$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Girls$initModel = {count: 0, brothers: 0};
var _user$project$Girls$init = {ctor: '_Tuple2', _0: _user$project$Girls$initModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Girls$Model = F2(
	function (a, b) {
		return {count: a, brothers: b};
	});
var _user$project$Girls$AddBrother = {ctor: 'AddBrother'};
var _user$project$Girls$Increment = {ctor: 'Increment'};
var _user$project$Girls$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: _elm_lang$html$Html$text(
				A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(model.brothers),
							' brothers ')))),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Girls$Increment),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Add Girl'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Girls$NewGirl = {ctor: 'NewGirl'};
var _user$project$Girls$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Increment') {
			return {
				...
				_2: {
					ctor: '::',
					_0: _user$project$Girls$NewGirl,
					_1: {ctor: '[]'}
				}
			};
		} else {
...
var _user$project$Parents$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Parents$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: _elm_lang$html$Html$text(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(model.sons),
						A2(
							_elm_lang$core$Basics_ops['++'],
							' sons and ',
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(model.daughters),
								A2(
									_elm_lang$core$Basics_ops['++'],
									' daughters, for a total of ',
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(model.sons + model.daughters),
										' children'))))))),
			_1: {ctor: '[]'}
		});
};
var _user$project$Parents$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'AddSon') {
			return {
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{daughters: model.daughters + 1}),
				_1: _elm_lang$core$Platform_Cmd$none,
				_2: {ctor: '[]'}
			};
		}
	});
var _user$project$Parents$initModel = {sons: 0, daughters: 0};
var _user$project$Parents$init = {ctor: '_Tuple2', _0: _user$project$Parents$initModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Parents$Model = F2(
	function (a, b) {
		return {sons: a, daughters: b};
	});
var _user$project$Parents$AddDaughter = {ctor: 'AddDaughter'};
var _user$project$Parents$AddSon = {ctor: 'AddSon'};
var _user$project$Parents$None = {ctor: 'None'};

var _user$project$Main$mainModelSubscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$validSubscriber = F3(
	function (model, memo, memosubscriber) {
		var _p0 = memosubscriber;
		var msgs = _p0._0;
		var subscriber = _p0._1;
		var condition = _p0._2;
		return (_elm_lang$core$Native_Utils.eq(memo, subscriber) && condition(model)) ? {
			ctor: '::',
			_0: msgs,
			_1: {ctor: '[]'}
		} : {ctor: '[]'};
	});
var _user$project$Main$validSender = F3(
	function (model, memo, memosender) {
		var _p1 = memosender;
		var sender = _p1._0;
		var msgs = _p1._1;
		var condition = _p1._2;
		return (_elm_lang$core$Native_Utils.eq(memo, sender) && condition(model)) ? {
			ctor: '::',
			_0: msgs,
			_1: {ctor: '[]'}
		} : {ctor: '[]'};
	});
var _user$project$Main$alwaysForward = function (model) {
	return true;
};
var _user$project$Main$mainModelInit = {
	ctor: '_Tuple2',
	_0: {},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {boys: a, girls: b, parents: c, main: d, msgs: e};
	});
var _user$project$Main$MainModel = {};
var _user$project$Main$ParentsMsg = function (a) {
	return {ctor: 'ParentsMsg', _0: a};
};
var _user$project$Main$GirlsMsg = function (a) {
	return {ctor: 'GirlsMsg', _0: a};
};
var _user$project$Main$BoysMsg = function (a) {
	return {ctor: 'BoysMsg', _0: a};
};
var _user$project$Main$init = function () {
	var _p2 = _user$project$Main$mainModelInit;
	var mainInit = _p2._0;
	var mainCmd = _p2._1;
	var _p3 = _user$project$Parents$init;
	var parentsInit = _p3._0;
	var parentsCmd = _p3._1;
	var _p4 = _user$project$Girls$init;
	var girlsInit = _p4._0;
	var girlsCmd = _p4._1;
	var _p5 = _user$project$Boys$init;
	var boysInit = _p5._0;
	var boysCmd = _p5._1;
	var initModel = {
		boys: boysInit,
	...
	var cmds = _elm_lang$core$Platform_Cmd$batch(
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$BoysMsg, boysCmd),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$GirlsMsg, girlsCmd),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$ParentsMsg, parentsCmd),
						_1: {ctor: '[]'}
					}
				}
			}
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				_user$project$Main$BoysMsg,
				_user$project$Boys$view(model.boys)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$map,
					_user$project$Main$GirlsMsg,
					_user$project$Girls$view(model.girls)),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$map,
						_user$project$Main$ParentsMsg,
						_user$project$Parents$view(model.parents)),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$subscriptions = function (model) {
	var mainSub = _user$project$Main$mainModelSubscriptions(model.main);
	var parentsSub = _user$project$Parents$subscriptions(model.parents);
	var girlsSub = _user$project$Girls$subscriptions(model.girls);
	var boysSub = _user$project$Boys$subscriptions(model.boys);
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Sub$map, _user$project$Main$BoysMsg, boysSub),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Sub$map, _user$project$Main$GirlsMsg, girlsSub),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Sub$map, _user$project$Main$ParentsMsg, parentsSub),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Main$FromParents = function (a) {
	return {ctor: 'FromParents', _0: a};
};
var _user$project$Main$FromGirls = function (a) {
	return {ctor: 'FromGirls', _0: a};
};
var _user$project$Main$FromBoys = function (a) {
	return {ctor: 'FromBoys', _0: a};
};
var _user$project$Main$memoSenders = {
	ctor: '::',
	_0: {
		ctor: '_Tuple3',
		_0: _user$project$Main$FromBoys(_user$project$Boys$NewBoy),
		_1: _user$project$Main$GirlsMsg(_user$project$Girls$AddBrother),
		_2: _user$project$Main$alwaysForward
	},
	_1: {
		ctor: '::',
		_0: {
			ctor: '_Tuple3',
			_0: _user$project$Main$FromGirls(_user$project$Girls$NewGirl),
			_1: _user$project$Main$BoysMsg(_user$project$Boys$AddSister),
			_2: _user$project$Main$alwaysForward
		},
		_1: {ctor: '[]'}
	}
};
var _user$project$Main$memoSubscribers = {
	ctor: '::',
	_0: {
		ctor: '_Tuple3',
		_0: _user$project$Main$ParentsMsg(_user$project$Parents$AddDaughter),
		_1: _user$project$Main$FromGirls(_user$project$Girls$NewGirl),
		_2: function (m) {
			return _elm_lang$core$Native_Utils.cmp(m.parents.sons + m.parents.daughters, 2) < 0;
		}
	},
	_1: {
		ctor: '::',
		_0: {
			ctor: '_Tuple3',
			_0: _user$project$Main$ParentsMsg(_user$project$Parents$AddSon),
			_1: _user$project$Main$FromBoys(_user$project$Boys$NewBoy),
			_2: function (m) {
				return _elm_lang$core$Native_Utils.cmp(m.parents.sons + m.parents.daughters, 2) < 0;
			}
		},
...
var _user$project$Main$routeMemos = F2(
	function (model, memo) {
		var subscribers = A2(
			_elm_lang$core$List$concatMap,
			A2(_user$project$Main$validSubscriber, model, memo),
			_user$project$Main$memoSubscribers);
		var senders = A2(
			_elm_lang$core$List$concatMap,
			A2(_user$project$Main$validSender, model, memo),
			_user$project$Main$memoSenders);
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p6 = function () {
			...
			switch (_p7.ctor) {
				case 'BoysMsg':
					var _p8 = A2(_user$project$Boys$update, _p7._0, model.boys);
					var newModel = _p8._0;
					var newCmds = _p8._1;
					var newMemos = _p8._2;
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{boys: newModel}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$BoysMsg, newCmds),
						_2: A2(_elm_lang$core$List$map, _user$project$Main$FromBoys, newMemos)
					};
				case 'GirlsMsg':
					var _p9 = A2(_user$project$Girls$update, _p7._0, model.girls);
					var newModel = _p9._0;
					var newCmds = _p9._1;
					var newMemos = _p9._2;
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{girls: newModel}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$GirlsMsg, newCmds),
						_2: A2(_elm_lang$core$List$map, _user$project$Main$FromGirls, newMemos)
					};
				default:
					var _p10 = A2(_user$project$Parents$update, _p7._0, model.parents);
					var newModel = _p10._0;
					var newCmds = _p10._1;
					var newMemos = _p10._2;
					return {
						ctor: '_Tuple3',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{parents: newModel}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$ParentsMsg, newCmds),
						_2: A2(_elm_lang$core$List$map, _user$project$Main$FromParents, newMemos)
					};
			}
		}();
		var newModel = _p6._0;
		var cmds = _p6._1;
		var memos = _p6._2;
		var modelWithMsg = _elm_lang$core$Native_Utils.update(
			newModel,
			{
				msgs: {
					ctor: '::',
		...
		var msgs = A2(
			_elm_lang$core$List$concatMap,
			_user$project$Main$routeMemos(model),
			memos);
		var finalModel = A3(
			_elm_lang$core$List$foldl,
			_user$project$Main$deliverMsgs,
			{ctor: '_Tuple2', _0: modelWithMsg, _1: cmds},
			msgs);
		return finalModel;
	});
var _user$project$Main$deliverMsgs = F2(
	function (msg, _p11) {
		var _p12 = _p11;
		var _p14 = _p12._0;
		var _p13 = A2(_user$project$Main$update, msg, _p14);
		var newModel = _p13._0;
		var newCmd = _p13._1;
		var allCmds = _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: _p12._1,
				_1: {
		...
		var olderMsgs = _p14.msgs;
		var newModelWithMsgs = _elm_lang$core$Native_Utils.update(
			newModel,
			{
				msgs: _elm_lang$core$List$concat(
					{
						ctor: '::',
						_0: olderMsgs,
						_1: {
		...
		return {ctor: '_Tuple2', _0: newModelWithMsgs, _1: allCmds};
	});
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Parents.Msg":{"args":[],"tags":{"AddDaughter":[],"AddSon":[]}},"Boys.Msg":{"args":[],"tags":{"AddSister":[],"Increment":[]}},"Girls.Msg":{"args":[],"tags":{"AddBrother":[],"Increment":[]}},"Main.Msg":{"args":[],"tags":{"GirlsMsg":["Girls.Msg"],"BoysMsg":["Boys.Msg"],"ParentsMsg":["Parents.Msg"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
